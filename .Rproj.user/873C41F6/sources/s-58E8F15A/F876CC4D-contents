...
#Quick histogram
hist(df_full$fd, main=paste(sUser, sDataSet))
...
read_min <- min(df_full$MonthRead)

# Generate list and count of unique meters
meterlist <- unique(df_full$MeterID)
